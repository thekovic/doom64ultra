...
void	Z_Init (void) COLD;
memzone_t *Z_InitZone (byte *base, int size) COLD;

void    Z_SetAllocBase(memzone_t *mainzone) COLD;
...
int P_Ticker (void) HOT;
void P_Drawer (void) HOT;
...
void I_Error(const char *error, ...) __attribute__((format (printf, 1, 2))) __attribute__((noreturn)) COLD;
